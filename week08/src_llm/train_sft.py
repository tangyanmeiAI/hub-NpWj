...
MODEL_PATH = ROOT.parent.parent / "pretrain_models" / "models--Qwen--Qwen2.5-1.5B-Instruct"
...
def main():
    ...
    model = AutoModelForCausalLM.from_pretrained(
        ...
        torch_dtype=torch.float16 if device.type == "xpu" else torch.float32,  # transformers 5.x 用 dtype= 不用 torch_dtype=
