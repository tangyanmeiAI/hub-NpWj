...
-------------------------------------------------------------------
BERT + Linear                 0.7195     0.7956     0.7556        265
BERT + CRF                    0.7164     0.7926     0.7526        245
LLM zero-shot (qwen-plus)     0.6907     0.4718     0.5607        N/A
LLM few-shot (qwen-plus)      0.6881     0.5282     0.5976        N/A

  注：LLM 结果基于验证集 100 条采样，非完整测试集

================================================================================
关键教学结论：
  1. CRF vs Linear：F1 ↓0.0030
  2. 线性头非法序列：265 条；CRF 非法序列：0 条
     → CRF 通过 Viterbi 解码在数学上保证序列合法性
  3. 微调 BERT vs LLM few-shot：F1 差距 0.1580
     → 特定领域NER任务中，小模型微调通常显著优于大模型zero/few-shot
================================================================================
